    ...
    >
      <div className="relative flex w-full flex-1 scale-y-125 items-center justify-center isolate z-0 pointer-events-none [mask-image:radial-gradient(ellipse_65%_80%_at_50%_35%,#000_40%,transparent_100%)]">
        ...
        <motion.div
          ...
          className="absolute inset-auto right-1/2 h-52 sm:h-64 w-[16rem] sm:w-[30rem] bg-gradient-conic from-cyan-500 via-transparent to-transparent text-white [--conic-position:from_70deg_at_center_top] blur-[2px] [mask-image:linear-gradient(to_bottom,black_30%,transparent_90%)] dark:opacity-85 opacity-40 transform-gpu"
        />
        ...
        <motion.div
          ...
          className="absolute inset-auto left-1/2 h-52 sm:h-64 w-[16rem] sm:w-[30rem] bg-gradient-conic from-transparent via-transparent to-cyan-500 text-white [--conic-position:from_290deg_at_center_top] blur-[2px] [mask-image:linear-gradient(to_bottom,black_30%,transparent_90%)] dark:opacity-85 opacity-40 transform-gpu"
        />
        ...
        <motion.div
          ...
          className="absolute inset-auto z-30 h-28 sm:h-36 w-48 sm:w-72 -translate-y-[4.5rem] sm:-translate-y-[5.5rem] rounded-full bg-cyan-400/35 blur-2xl sm:blur-3xl transform-gpu"
        />
        ...
        <motion.div
          ...
          className="absolute inset-auto z-50 h-[1.5px] w-[18rem] sm:w-[32rem] -translate-y-[5.8rem] sm:-translate-y-[6.8rem] bg-gradient-to-r from-transparent via-cyan-400 to-transparent shadow-[0_0_20px_#06b6d4,0_0_40px_#10b981] transform-gpu"
        />
      </div>
