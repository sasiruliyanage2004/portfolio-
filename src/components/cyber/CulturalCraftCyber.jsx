  ...
  return (
    <section ref={sectionRef} id="craft" className="relative overflow-hidden bg-transparent px-6 py-24 lg:px-10 scroll-mt-24">
      <motion.div style={{ scale, y }} className="mx-auto max-w-7xl relative">
        {/* Section Header (Clean, minimalist, no clutter) */}
        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
          {CRAFT_ITEMS.map((item, idx) => (
            <div
              key={idx}
              className="project-card-obsidian noise-overlay relative flex flex-col justify-between rounded-3xl p-7 transition-all duration-300 hover:border-cyan-400/50 shadow-xl"
            >
              <div>
