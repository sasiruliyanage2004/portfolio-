...
export default function HeaderMinimal({ briefingMode, setBriefingMode }) {
  ...
  return (
    <motion.header
      ...
      className={`fixed top-10 inset-x-0 z-40 transition-colors duration-300 ${
    ...
    >
      <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
        <a href="#top" className="font-semibold tracking-tight text-[15px] text-zinc-100 flex items-center gap-1">
          MINIMAL<span className="text-cyan-400">.</span>
        </a>
