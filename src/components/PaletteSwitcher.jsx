  ...
  return (
    <div className="fixed bottom-24 right-8 z-[70]">
      ...
      <motion.button
        ...
        className="relative flex h-12 w-12 items-center justify-center rounded-full border border-white/20 bg-[#090d16]/90 backdrop-blur-xl shadow-2xl transition-all hover:border-cyan-400/50 cursor-pointer"
      >
        <span
        ...
        />
        <Palette className="h-5 w-5 text-cyan-300 relative z-10" />
      </motion.button>
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="absolute bottom-16 right-0 w-72 rounded-3xl border border-white/20 bg-[#090d16]/95 backdrop-blur-2xl p-4 shadow-2xl text-slate-100 z-50 overflow-hidden"
          >
            {/* Header */}
            <div className="flex items-center justify-between border-b border-white/10 pb-3 mb-3">
              ...
              <span className="font-mono text-[10px] text-slate-400">4 Palettes</span>
            </div>
              ...
              {PALETTES.map((palette) => {
                ...
                return (
                  ...
                  >
                    ...
                    {isSelected && (
                      <div className="h-5 w-5 rounded-full bg-cyan-400 flex items-center justify-center text-[#05070e] shrink-0">
